...
public interface FlickrAPI {
    ...
    @GET("services/rest/")
    Call<PhotoInfo> getInfo(@Query("method") String method, @Query("api_key") String api_key, @Query("photo_id") String photo_id, @Query("format") String format, @Query("nojsoncallback") String nojsoncallback);
}
